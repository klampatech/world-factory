/**
 * WOR-866: Complete End-to-End Smoke Test
...
test.describe('WOR-866: Backend API Tests', () => {
  let worldId: string;
...
test.describe('WOR-866: Frontend UI Tests', () => {
  ...
  test('F1: Home page loads with World Factory title', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F1-home-loaded.png` });
  ...
  test('F2: World list displays correctly', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F2-world-list.png` });
  ...
  test('F3: Generate new world form works', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F3-generate-form.png` });
  ...
  test('F4: Map view loads when world selected', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F4-map-view.png` });
  ...
  test('F5: Tab navigation works', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F5-tab-navigation.png` });
  ...
  test('F6: Timeline view loads', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F6-timeline.png` });
  ...
  test('F7: Dashboard/stats view loads', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F7-dashboard.png` });
  ...
  test('F8: Figures view loads', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F8-figures.png` });
  ...
  test('F9: No critical console errors', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOTS_DIR}/WOR-866-F9-console-check.png` });
...
test('ZZ: Summary', async () => {
  console.log('\n' + '='.repeat(60));
  console.log('WOR-866 SMOKE TEST SUMMARY');
