...
const SCREENSHOT_DIR = 'screenshots/smoke-test-WOR-904/';
const screenshots = [];
...
async function main() {
  ...
  const report = `# WOR-904 Smoke Test Report
...
`;
  ...
  writeFileSync('WOR-904-SMOKE-TEST-REPORT.md', report);
  console.log('\n📄 Report saved to WOR-904-SMOKE-TEST-REPORT.md');
