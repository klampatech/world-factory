...
impl EventType {
    ...
    pub fn participant_types(&self) -> Vec<&'static str> {
        match self {
            ...
            Self::Earthquake | Self::Flood | Self::Drought | Self::Volcano => {
                vec!["regions", "settlements"]
            }
            ...
            Self::ReligiousEvent | Self::ReligiousReformation => {
                vec!["religious_figures", "followers"]
            }
...
mod tests {
    ...
    fn test_event_type_categories() {
        assert_eq!(
            EventType::SettlementFounded.category(),
