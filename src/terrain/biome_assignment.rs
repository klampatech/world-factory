...
use super::biome::{BiomeType, BiomeColor, BiomeColorMapping, ClimateZone, ElevationZone, MoistureLevel, AlpineBiomeConfig};
...
impl BiomeAssignmentMatrix {
    ...
    pub fn apply_coherence(
        ...
        let neighbor_zones: Vec<usize> = neighbors.iter().map(|n| self.biome_to_climate_index(*n)).collect();
    ...
    fn biome_to_climate_index(&self, biome: BiomeType) -> usize {
        match biome {
            ...
            BiomeType::TropicalSavanna | BiomeType::TropicalDryForest => 0,
            BiomeType::SubtropicalRainforest | BiomeType::SubtropicalSeasonalForest |
            BiomeType::SubtropicalSteppe | BiomeType::SubtropicalDesert => 1,
            BiomeType::TemperateRainforest | BiomeType::TemperateDeciduousForest |
            BiomeType::TemperateMixedForest | BiomeType::TemperateSteppe |
            BiomeType::TemperateDesert => 2,
            BiomeType::BorealTaiga | BiomeType::BorealForest |
            BiomeType::TemperateGrassland => 3,
            ...
            BiomeType::CoastalWetland | BiomeType::Mangrove | BiomeType::CoralReef |
            BiomeType::KelpForest | BiomeType::OpenOcean => 2,
            BiomeType::HotDesert | BiomeType::ColdDesert | BiomeType::SemiAridSteppe => 2,
            BiomeType::MagicalForest | BiomeType::CrystallineDesert |
            BiomeType::BioluminescentOcean | BiomeType::VolcanicLandscape |
            BiomeType::ToxicSwamp | BiomeType::FloatingIslands => 2,
        }
    }
    ...
    fn assign_biome(
        ...
        match (climate, moisture) {
            ...
            (ClimateZone::Tropical, MoistureLevel::Arid | MoistureLevel::HyperArid) => BiomeType::HotDesert,
            
            // SUBTROPICAL
            (ClimateZone::Subtropical, MoistureLevel::PerHumid) => BiomeType::SubtropicalRainforest,
            (ClimateZone::Subtropical, MoistureLevel::Humid) => BiomeType::SubtropicalSeasonalForest,
            ...
            (ClimateZone::Subtropical, MoistureLevel::Arid | MoistureLevel::HyperArid) => BiomeType::SubtropicalDesert,
            ...
            (ClimateZone::Temperate, MoistureLevel::Arid | MoistureLevel::HyperArid) => BiomeType::TemperateDesert,
            
            // BOREAL
            (ClimateZone::Boreal, MoistureLevel::PerHumid | MoistureLevel::Humid) => BiomeType::BorealTaiga,
            ...
            (ClimateZone::Boreal, MoistureLevel::Arid | MoistureLevel::HyperArid) => BiomeType::ColdDesert,
            
            // POLAR
            (ClimateZone::Polar, MoistureLevel::PerHumid | MoistureLevel::Humid) => BiomeType::Tundra,
            (ClimateZone::Polar, MoistureLevel::SubHumid | MoistureLevel::SemiArid) => BiomeType::Arctic,
            (ClimateZone::Polar, MoistureLevel::Arid | MoistureLevel::HyperArid) => BiomeType::PolarDesert,
        }
    }
    ...
    pub fn assign_marine(
        ...
        let factors = vec![
            AssignmentFactor { name: "is_coastal".into(), weight: 0.3, value: is_coastal.to_string() },
            AssignmentFactor { name: "is_ocean".into(), weight: 0.2, value: is_ocean.to_string() },
            AssignmentFactor { name: "depth".into(), weight: 0.3, value: format!("{:.0}m", depth) },
        ];
...
mod tests {
    ...
    fn test_climate_zone_determination() {
        ...
        assert!(matches!(
            ...
            BiomeType::TropicalRainforest | BiomeType::TropicalSeasonalForest | BiomeType::TropicalSavanna
        ));
        
        assert!(matches!(
            matrix.assign(100.0, 45.0, 1000.0, 12.0).biome,
            BiomeType::TemperateDeciduousForest | BiomeType::TemperateMixedForest | BiomeType::TemperateRainforest
        ));
    ...
    fn test_moisture_level_from_precipitation() {
        ...
        assert!(matches!(r1.biome, BiomeType::HotDesert | BiomeType::SubtropicalDesert));
    ...
    fn test_deterministic_reproduction() {
        ...
        let result1 = matrix.assign(
            params.0, params.1, params.2, params.3,
        );
        let result2 = matrix.assign(
            params.0, params.1, params.2, params.3,
        );
    ...
    fn test_elevation_adjustment() {
        ...
        let adjusted = BiomeType::TemperateDeciduousForest
            .with_elevation_adjustment(100.0, 15.0, &config);
        assert_eq!(adjusted, BiomeType::TemperateDeciduousForest);
        
        // Temperate biome at alpine elevation - should become alpine
        let adjusted = BiomeType::TemperateDeciduousForest
            .with_elevation_adjustment(3500.0, 2.0, &config);
        assert!(matches!(adjusted, BiomeType::AlpineTundra | BiomeType::MontaneGrassland));
        
        // Very high elevation with cold temp - snow/glacier
        let adjusted = BiomeType::TemperateDeciduousForest
            .with_elevation_adjustment(5000.0, -10.0, &config);
    ...
    fn test_geographic_coherence() {
        ...
        let result = matrix.apply_coherence(
        ...
        assert!(matches!(result, BiomeType::Tundra | BiomeType::Arctic | BiomeType::TropicalRainforest));
    }
