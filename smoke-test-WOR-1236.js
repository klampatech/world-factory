...
const SCREENSHOT_DIR = '/home/kyle/projects/world-generator/screenshots/smoke-WOR-1236';
const REPORT_FILE = '/home/kyle/projects/world-generator/WOR-1236-SMOKE-TEST-REPORT.json';
...
async function run() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║         WOR-1236 Smoke Test - System Health Check             ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  // 13. GET /api/v1/worlds/:id/artifacts
  await apiTest('GET /api/v1/worlds/:id/artifacts?limit=5', 'GET', `/api/v1/worlds/${worldId}/artifacts?limit=5`, 200);
  
  // 14. GET /api/v1/worlds/:id/export
  await apiTest('GET /api/v1/worlds/:id/export', 'GET', `/api/v1/worlds/${worldId}/export`, 200);
  
  // 15. DELETE /api/v1/worlds/:id
  ...
  try {
    ...
    results.frontend.tests.push({ name: 'Homepage loads', passed: true, title });
    results.frontend.passed++;
