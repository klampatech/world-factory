...
const SCREENSHOTS_DIR = '/home/kyle/projects/world-generator/screenshots/WOR-1162';
...
async function runSmokeTest() {
  console.log('=== WORLD FACTORY COMPREHENSIVE SMOKE TEST (WOR-1162) ===');
    ...
    { 
      ...
      fn: async () => {
        const resp = await fetch(`${API_BASE}/worlds`, {
          ...
          body: JSON.stringify({ name: 'QA-Smoke-WOR1162', seed: 11621162, config: { genre: 'fantasy' } })
        });
  ...
  // Write reports
  fs.writeFileSync('/home/kyle/projects/world-generator/WOR-1162-SMOKE-TEST-REPORT.json', JSON.stringify(results, null, 2));
  
  const mdReport = `# WOR-1162 Smoke Test Report
...
`;
  fs.writeFileSync('/home/kyle/projects/world-generator/WOR-1162-SMOKE-TEST-REPORT.md', mdReport);
