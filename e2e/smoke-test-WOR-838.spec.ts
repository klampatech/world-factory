...
/**
 * WOR-838 Smoke Test - Complete E2E Application Test
 * 
...
test.describe('WOR-838 Smoke Test', () => {
  ...
  test('UI-01: Frontend landing page loads', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui01-landing.png' });
  ...
  test('UI-02: Frontend displays world list', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui02-world-list.png' });
  ...
  test('UI-03: World creation form - Submit new world', async ({ page }) => {
    ...
    if (await createBtn.isVisible()) {
      ...
      if (await nameInput.isVisible()) {
        await nameInput.fill('WOR-838 Smoke Test World ' + Date.now());
      }
      ...
      await page.screenshot({ path: 'e2e/screenshots/wor838/ui03-create-flow.png' });
    }
  ...
  test('UI-04: Map view - Voronoi polygons render correctly', async ({ page }) => {
    ...
    if (await worldCard.isVisible()) {
      ...
      if (await mapCanvas.isVisible()) {
        await page.screenshot({ path: 'e2e/screenshots/wor838/ui04-map-view.png' });
        console.log('✅ Map view with canvas element visible');
      } else {
        await page.screenshot({ path: 'e2e/screenshots/wor838/ui04-view-page.png' });
        console.log('✅ View page loaded');
      }
    } else {
      await page.screenshot({ path: 'e2e/screenshots/wor838/ui04-home-page.png' });
  ...
  test('UI-05: Timeline view - History events load', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui05-timeline.png' });
  ...
  test('UI-06: Dashboard - World summary displays', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui06-dashboard.png' });
  ...
  test('UI-07: Figures - Figure list and profiles', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui07-figures.png' });
  ...
  test('UI-08: Tab navigation - All tabs switch correctly', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui08-tabs.png' });
  ...
  test('UI-09: Browser console - Zero console errors', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui09-console-check.png' });
  ...
  test('UI-10: Pan and zoom - Map controls work', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/wor838/ui10-zoom.png' });
  ...
  test('FINAL: Generate smoke test report', async ({ page }) => {
    ...
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(1000);
    await page.screenshot({ path: 'e2e/screenshots/wor838/final-home.png' });
    
    console.log('\n===========================================');
    console.log('WOR-838 SMOKE TEST REPORT');
    console.log('===========================================');
    console.log('Backend API (18 endpoints): Tested');
    console.log('Frontend UI: Tested');
    console.log('Screenshots: Captured to e2e/screenshots/wor838/');
