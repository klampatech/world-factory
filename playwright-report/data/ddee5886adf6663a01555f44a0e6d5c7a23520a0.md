...
- Name: frontend-smoke-tests.spec.ts >> Frontend Smoke Tests (TC-UI-001 to TC-UI-012) >> TC-UI-006: Zoom controls visible
- Location: e2e/frontend-smoke-tests.spec.ts:81:7
