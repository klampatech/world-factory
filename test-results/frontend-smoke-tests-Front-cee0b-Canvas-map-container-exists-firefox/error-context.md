...
- Name: frontend-smoke-tests.spec.ts >> Frontend Smoke Tests (TC-UI-001 to TC-UI-012) >> TC-UI-002: Canvas map container exists
- Location: e2e/frontend-smoke-tests.spec.ts:22:7
