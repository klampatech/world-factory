...
- Name: e2e/smoke-test-all-endpoints.spec.ts >> WOR-348: All 18 API Endpoints >> 2. GET /api/v1/worlds - List worlds
- Location: e2e/smoke-test-all-endpoints.spec.ts:19:7

# Error details

```
TypeError: _test.request.get is not a function
```
