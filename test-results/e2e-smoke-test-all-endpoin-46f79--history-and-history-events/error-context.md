...
- Name: e2e/smoke-test-all-endpoints.spec.ts >> WOR-348: All 18 API Endpoints >> 7-8. GET /api/v1/worlds/:id/history and /history/events
- Location: e2e/smoke-test-all-endpoints.spec.ts:60:7
