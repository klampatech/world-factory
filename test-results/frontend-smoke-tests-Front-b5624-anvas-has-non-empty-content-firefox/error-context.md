...
- Name: frontend-smoke-tests.spec.ts >> Frontend Smoke Tests (TC-UI-001 to TC-UI-012) >> TC-UI-003: Map canvas has non-empty content
- Location: e2e/frontend-smoke-tests.spec.ts:29:7
