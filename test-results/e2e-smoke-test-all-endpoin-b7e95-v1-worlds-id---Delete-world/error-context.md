...
- Name: e2e/smoke-test-all-endpoints.spec.ts >> WOR-348: All 18 API Endpoints >> 4. DELETE /api/v1/worlds/:id - Delete world
- Location: e2e/smoke-test-all-endpoints.spec.ts:34:7
