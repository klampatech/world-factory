...
- Name: e2e/smoke-test-all-endpoints.spec.ts >> WOR-348: All 18 API Endpoints >> 1. POST /api/v1/worlds - Create world
- Location: e2e/smoke-test-all-endpoints.spec.ts:8:7
