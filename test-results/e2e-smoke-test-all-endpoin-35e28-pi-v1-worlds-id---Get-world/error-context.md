...
- Name: e2e/smoke-test-all-endpoints.spec.ts >> WOR-348: All 18 API Endpoints >> 3. GET /api/v1/worlds/:id - Get world
- Location: e2e/smoke-test-all-endpoints.spec.ts:27:7
