...
- Name: frontend-smoke-tests.spec.ts >> Frontend Smoke Tests (TC-UI-001 to TC-UI-012) >> TC-UI-012: Wonders overlay button works
- Location: e2e/frontend-smoke-tests.spec.ts:186:7
