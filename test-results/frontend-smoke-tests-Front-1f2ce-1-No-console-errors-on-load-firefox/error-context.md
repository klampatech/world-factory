...
- Name: frontend-smoke-tests.spec.ts >> Frontend Smoke Tests (TC-UI-001 to TC-UI-012) >> TC-UI-011: No console errors on load
- Location: e2e/frontend-smoke-tests.spec.ts:163:7
